...
import { signIn } from "next-auth/react"; // ← ye import karo
...
const GithubIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" className="mr-3" fill="currentColor">
    ...
    <Card className="w-full max-w-md bg-white/5 border border-white/10 backdrop-blur-sm shadow-2xl">
      ...
      <CardContent className="grid gap-4 pb-2">
        <Button
          ...
          variant="outline"
          className="h-14 w-full rounded-2xl border border-zinc-700 bg-zinc-900/80 text-base font-medium text-white shadow-md shadow-black/30"
        >
          <GoogleIcon />
